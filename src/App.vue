...
async function onRegedit() {
  ...
  if (form.password !== form.confirmPassword) {
    ElNotification({title: '提示信息', message: '两次密码不一致。', type: 'warning'})
    return
  }
    ...
    <div class="resume-form" :style="styleForm">
      <el-form :model="form" label-width="auto" style="max-width: 600px">
        ...
        <el-form-item label="确人密码" v-if="!regedit">
          <el-input v-model="form.confirmPassword" type="password" placeholder="确人密码" clearable/>
        </el-form-item>
        <el-form-item label=" " class="el-form-submit">
          <div class="el-form-submit-buttons">
            ...
            <el-button type="primary" v-if="!regedit" @click="onRegedit">注册</el-button>
            <el-button @click="onReset">重置</el-button>
          </div>
          <el-link @click="regedit = !regedit">{{ regedit ? '注册' : '登录' }}</el-link>
        </el-form-item>
      </el-form>
    </div>
  </el-container>
