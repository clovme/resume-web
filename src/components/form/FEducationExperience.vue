...
<template>
  <div>
    <div class="split-row-module" v-for="_ in 3">
      <el-row class="split-row-1">
        <el-col :span="5">
          <div class="split-1">
            <label>学校名称</label>
            <el-input v-model="data.desiredPosition" placeholder="请输入学校名称" clearable />
          </div>
        </el-col>
        <el-col :span="4">
          <div class="split-1">
            <label>所学专业</label>
            <el-input v-model="data.desiredCity" placeholder="请输入专业名称" clearable />
          </div>
        </el-col>
        <el-col :span="6">
          <div class="split-1" style="width: 320px">
            <label>就读时间</label>
            <el-date-picker v-model="data.birthday" style="width: 120px" type="month" placeholder="请选开始时间" />-
            <el-date-picker v-model="data.birthday" style="width: 120px" type="month" placeholder="请选结束时间" />
            <el-checkbox v-model="data.isAge" label="至今" />
          </div>
        </el-col>
        <el-col :span="4">
          <div class="split-1">
            <label>学历</label>
            <el-select style="width: 100px" v-model="data.workExperienceYears" placeholder="请选择学历">
    ...
    <el-row>
      <el-col>
        <el-button type="success" size="large" :icon="plus" round>新增一条工作经历</el-button>
      </el-col>
    </el-row>
  </div>
</template>
