...
const VLineBox = {
    ...
    margin: (props: ILineBox): {margin: string, padding: string} => {
        ...
        const indexs = {top: [1, 3], right: [0, 2], bottom: [1, 3], left: [0, 2]}[position] as [0, 2];

        let margin = [`${props.margin}px`, `${props.margin}px`, `${props.margin}px`, `${props.margin}px`]
        let padding = [`${props.margin}px`, `${props.margin}px`, `${props.margin}px`, `${props.margin}px`]
